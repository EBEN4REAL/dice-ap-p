...
export enum VirtualFloorInternalState {
  CancelledBecauseFlagged = 'CANCELLED_BECAUSE_FLAGGED',
  CancelledBecauseResolvedNoWinners = 'CANCELLED_BECAUSE_RESOLVED_NO_WINNERS',
  CancelledBecauseUnresolvable = 'CANCELLED_BECAUSE_UNRESOLVABLE',
  ResolvedWinners = 'RESOLVED_WINNERS',
  RunningOrClosedResultChallenged = 'RUNNING_OR_CLOSED__RESULT_CHALLENGED',
  RunningOrClosedResultNone = 'RUNNING_OR_CLOSED__RESULT_NONE',
  RunningOrClosedResultSet = 'RUNNING_OR_CLOSED__RESULT_SET'
}
