...
export interface VirtualFloorComputedStateWrapperInterface
  extends utils.Interface {
  contractName: "VirtualFloorComputedStateWrapper";
  functions: {
...
export interface VirtualFloorComputedStateWrapper extends BaseContract {
  contractName: "VirtualFloorComputedStateWrapper";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VirtualFloorComputedStateWrapperInterface;
